package com.dji.videostreamdecodingsample.rtsp;
...
public abstract class DroneCameraBase
  ...
  public DroneCameraBase(SurfaceView surfaceView) {
    context = surfaceView.getContext();
    // Camera Data will be added externally.
    // cameraManager = new Camera1ApiManager(surfaceView, this);
    init();
  }

  public DroneCameraBase(TextureView textureView) {
  ...
  public DroneCameraBase(OpenGlView openGlView) {
  ...
  @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2)
  public DroneCameraBase(LightOpenGlView lightOpenGlView) {
  ...
  @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2)
  public DroneCameraBase(Context context) {
  ...
  public boolean prepareVideo(int width, int height, int fps, int bitrate, int iFrameInterval,
    ...
    Log.i("ALEX:DroneCameraBase", String.format("PrepareVideo: %dx%d fps:%d bitrate:%d, iFI:%d, rot:%d, avc:%d, avcL: %d",
            width, height, fps, bitrate, iFrameInterval, rotation, avcProfile, avcProfileLevel));
  ...
  public boolean prepareVideo() {
    ...
    return prepareVideo(1632, 1088, 25, 10000 * 1024, rotation);
  }
  ...
  public void getVideoData(ByteBuffer h264Buffer, MediaCodec.BufferInfo info) {
    Log.i("ALEX", String.format("DroneCameraBase::getVideoData bufferInfo: %s", info.toString()));
